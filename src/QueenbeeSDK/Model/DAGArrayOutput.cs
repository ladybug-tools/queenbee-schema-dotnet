...
namespace QueenbeeSDK
{
    ...
    public partial class DAGArrayOutput : GenericOutput, IEquatable<DAGArrayOutput>, IValidatableObject
    {
        ...
        (
            ...
            Dictionary<string, string> annotations= default, string description= default, ItemType itemsType= default // Optional parameters
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGArrayOutput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>DAGArrayOutput object</returns>
        public virtual DAGArrayOutput DuplicateDAGArrayOutput()
        {
        ...
        {
            return DuplicateDAGArrayOutput();
        }
