...
namespace QueenbeeSDK
{
    ...
    public partial class StepFolderInput : GenericInput, IEquatable<StepFolderInput>, IValidatableObject
    {
        ...
        /// </summary>
        /// <returns>StepFolderInput object</returns>
        public static StepFolderInput FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<StepFolderInput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>StepFolderInput object</returns>
        public virtual StepFolderInput DuplicateStepFolderInput()
        {
