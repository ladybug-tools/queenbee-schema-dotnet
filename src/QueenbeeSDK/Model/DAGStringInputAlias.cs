...
namespace QueenbeeSDK
{
    ...
    /// </summary>
    [DataContract(Name = "DAGStringInputAlias")]
    public partial class DAGStringInputAlias : DAGGenericInputAlias, IEquatable<DAGStringInputAlias>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DAGStringInputAlias" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DAGStringInputAlias() 
        { 
            // Set non-required readonly properties with defaultValue
            this.Type = "DAGStringInputAlias";
        }
        ...
        ) : base(name: name, annotations: annotations, description: description, _default: _default, spec: spec, platform: platform, handler: handler)// BaseClass
        {
        ...
        /// </summary>
        /// <returns>DAGStringInputAlias object</returns>
        public static DAGStringInputAlias FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<DAGStringInputAlias>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>DAGStringInputAlias object</returns>
        public virtual DAGStringInputAlias DuplicateDAGStringInputAlias()
        {
        ...
        {
            return DuplicateDAGStringInputAlias();
        }
        ...
        {
            return this.Equals(input as DAGStringInputAlias);
        }

        /// <summary>
        /// Returns true if DAGStringInputAlias instances are equal
        /// </summary>
        /// <param name="input">Instance of DAGStringInputAlias to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DAGStringInputAlias input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^DAGStringInputAlias$", RegexOptions.CultureInvariant);
