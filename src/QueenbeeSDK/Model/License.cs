...
namespace QueenbeeSDK.Model
{
    ...
    public partial class License :  IEquatable<License>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="License" /> class.
        /// </summary>
        /// <param name="name">The license name used for the recipe. (required).</param>
        /// <param name="url">A URL to the license used for the recipe..</param>
        public License
        (
           string name, // Required parameters
           string url= default// Optional parameters
        )// BaseClass
        {
        ...
        /// </summary>
        /// <value>The license name used for the recipe.</value>
        ...
        /// </summary>
        /// <value>A URL to the license used for the recipe.</value>
