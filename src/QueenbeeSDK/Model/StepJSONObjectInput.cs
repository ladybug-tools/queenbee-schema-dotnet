...
namespace QueenbeeSDK
{
    ...
    /// A JSON object input.
    /// </summary>
    [DataContract(Name = "StepJSONObjectInput")]
    public partial class StepJSONObjectInput : GenericInput, IEquatable<StepJSONObjectInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StepJSONObjectInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StepJSONObjectInput() 
        { 
        ...
        ) : base(name: name, annotations: annotations, description: description)// BaseClass
        {
            ...
            this.Value = value ?? throw new ArgumentNullException("value is a required property for StepJSONObjectInput and cannot be null");
        ...
        /// </summary>
        /// <returns>StepJSONObjectInput object</returns>
        public static StepJSONObjectInput FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<StepJSONObjectInput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>StepJSONObjectInput object</returns>
        public virtual StepJSONObjectInput DuplicateStepJSONObjectInput()
        {
        ...
        {
            return DuplicateStepJSONObjectInput();
        }
        ...
        {
            return this.Equals(input as StepJSONObjectInput);
        }

        /// <summary>
        /// Returns true if StepJSONObjectInput instances are equal
        /// </summary>
        /// <param name="input">Instance of StepJSONObjectInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StepJSONObjectInput input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^StepJSONObjectInput$", RegexOptions.CultureInvariant);
