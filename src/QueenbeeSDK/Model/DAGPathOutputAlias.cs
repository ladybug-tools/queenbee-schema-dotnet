...
namespace QueenbeeSDK
{
    ...
    public partial class DAGPathOutputAlias : GenericOutput, IEquatable<DAGPathOutputAlias>, IValidatableObject
    {
        ...
        (
            string name, AnyOf<TaskReference,FileReference,FolderReference> from, List<string> platform, List<IOAliasHandler> handler, // Required parameters
        ...
        ) : base(name: name, annotations: annotations, description: description)// BaseClass
        {
            ...
            this.Platform = platform ?? throw new ArgumentNullException("platform is a required property for DAGPathOutputAlias and cannot be null");
            // to ensure "handler" is required (not null)
            this.Handler = handler ?? throw new ArgumentNullException("handler is a required property for DAGPathOutputAlias and cannot be null");
