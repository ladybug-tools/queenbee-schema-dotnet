...
{
    /// <summary>
    /// DAG alias boolean output.  This output loads the content from a file as a boolean.
    /// </summary>
    [DataContract(Name = "DAGBooleanOutputAlias")]
    public partial class DAGBooleanOutputAlias : GenericOutput, IEquatable<DAGBooleanOutputAlias>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DAGBooleanOutputAlias" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DAGBooleanOutputAlias() 
        { 
            // Set non-required readonly properties with defaultValue
            this.Type = "DAGBooleanOutputAlias";
        }
        ...
        ) : base(name: name, annotations: annotations, description: description)// BaseClass
        {
            ...
            this.From = from ?? throw new ArgumentNullException("from is a required property for DAGBooleanOutputAlias and cannot be null");
            // to ensure "platform" is required (not null)
            this.Platform = platform ?? throw new ArgumentNullException("platform is a required property for DAGBooleanOutputAlias and cannot be null");
            // to ensure "handler" is required (not null)
            this.Handler = handler ?? throw new ArgumentNullException("handler is a required property for DAGBooleanOutputAlias and cannot be null");
        ...
        public override string Type { get; protected internal set; }  = "DAGBooleanOutputAlias";
        ...
        public override string ToString(bool detailed)
        {
            ...
            sb.Append("DAGBooleanOutputAlias:\n");
        ...
        /// </summary>
        /// <returns>DAGBooleanOutputAlias object</returns>
        public static DAGBooleanOutputAlias FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<DAGBooleanOutputAlias>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>DAGBooleanOutputAlias object</returns>
        public virtual DAGBooleanOutputAlias DuplicateDAGBooleanOutputAlias()
        {
        ...
        {
            return DuplicateDAGBooleanOutputAlias();
        }
        ...
        {
            return this.Equals(input as DAGBooleanOutputAlias);
        }

        /// <summary>
        /// Returns true if DAGBooleanOutputAlias instances are equal
        /// </summary>
        /// <param name="input">Instance of DAGBooleanOutputAlias to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DAGBooleanOutputAlias input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^DAGBooleanOutputAlias$", RegexOptions.CultureInvariant);
