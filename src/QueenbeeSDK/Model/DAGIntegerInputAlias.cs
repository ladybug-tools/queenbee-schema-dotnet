...
namespace QueenbeeSDK
{
    ...
    /// </summary>
    [DataContract(Name = "DAGIntegerInputAlias")]
    public partial class DAGIntegerInputAlias : OpenAPIGenBaseModel, IEquatable<DAGIntegerInputAlias>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DAGIntegerInputAlias" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DAGIntegerInputAlias() 
        { 
            // Set non-required readonly properties with defaultValue
            this.Type = "DAGIntegerInputAlias";
        }
        ...
        public DAGIntegerInputAlias
        (
             string name, List<string> platform, List<IOAliasHandler> handler, // Required parameters
            Dictionary<string, string> annotations= default, string description= default, int _default= default, bool required = false, Object spec= default // Optional parameters
        ) : base()// BaseClass
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for DAGIntegerInputAlias and cannot be null");
            // to ensure "platform" is required (not null)
            this.Platform = platform ?? throw new ArgumentNullException("platform is a required property for DAGIntegerInputAlias and cannot be null");
            // to ensure "handler" is required (not null)
            this.Handler = handler ?? throw new ArgumentNullException("handler is a required property for DAGIntegerInputAlias and cannot be null");
        ...
        public override string ToString(bool detailed)
        {
            ...
            sb.Append("DAGIntegerInputAlias:\n");
        ...
        /// </summary>
        /// <returns>DAGIntegerInputAlias object</returns>
        public static DAGIntegerInputAlias FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<DAGIntegerInputAlias>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>DAGIntegerInputAlias object</returns>
        public virtual DAGIntegerInputAlias DuplicateDAGIntegerInputAlias()
        {
        ...
        {
            return DuplicateDAGIntegerInputAlias();
        }
        ...
        {
            return this.Equals(input as DAGIntegerInputAlias);
        }

        /// <summary>
        /// Returns true if DAGIntegerInputAlias instances are equal
        /// </summary>
        /// <param name="input">Instance of DAGIntegerInputAlias to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DAGIntegerInputAlias input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^DAGIntegerInputAlias$", RegexOptions.CultureInvariant);
