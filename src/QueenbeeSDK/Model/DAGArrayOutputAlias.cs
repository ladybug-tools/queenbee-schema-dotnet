...
namespace QueenbeeSDK
{
    ...
    public partial class DAGArrayOutputAlias : GenericOutput, IEquatable<DAGArrayOutputAlias>, IValidatableObject
    {
        /// <summary>
        ...
        ) : base(name: name, annotations: annotations, description: description)// BaseClass
        {
            ...
            this.Platform = platform ?? throw new ArgumentNullException("platform is a required property for DAGArrayOutputAlias and cannot be null");
            // to ensure "handler" is required (not null)
            this.Handler = handler ?? throw new ArgumentNullException("handler is a required property for DAGArrayOutputAlias and cannot be null");
