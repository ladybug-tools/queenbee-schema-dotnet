...
namespace QueenbeeSDK
{
    ...
    /// </summary>
    [DataContract(Name = "DAGIntegerOutput")]
    public partial class DAGIntegerOutput : GenericOutput, IEquatable<DAGIntegerOutput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DAGIntegerOutput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DAGIntegerOutput() 
        { 
        ...
        public override string Type { get; protected internal set; }  = "DAGIntegerOutput";
        ...
        /// </summary>
        /// <returns>DAGIntegerOutput object</returns>
        public static DAGIntegerOutput FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<DAGIntegerOutput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>DAGIntegerOutput object</returns>
        public virtual DAGIntegerOutput DuplicateDAGIntegerOutput()
        {
        ...
        {
            return DuplicateDAGIntegerOutput();
        }
        ...
        public override bool Equals(object input)
        {
            ...
            return this.Equals(input as DAGIntegerOutput);
        }

        /// <summary>
        /// Returns true if DAGIntegerOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of DAGIntegerOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DAGIntegerOutput input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^DAGIntegerOutput$", RegexOptions.CultureInvariant);
