...
namespace QueenbeeSDK.Model
{
    ...
    public partial class DAGIntegerOutput : GenericOutput,  IEquatable<DAGIntegerOutput>, IValidatableObject
    {
        ...
        ) : base(name: name, annotations: annotations, description: description)// BaseClass
        {
            ...
            if (from == null)
            {
                throw new InvalidDataException("from is a required property for DAGIntegerOutput and cannot be null");
            }
            else
            {
                this.From = from;
        ...
        [JsonProperty("type")]
        public string Type { get; private set; }  = "DAGIntegerOutput";
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DAGIntegerOutput {\n");
        ...
        /// </summary>
        /// <returns>DAGIntegerOutput object</returns>
        public DAGIntegerOutput DuplicateDAGIntegerOutput()
        {
