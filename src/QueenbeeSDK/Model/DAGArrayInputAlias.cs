...
namespace QueenbeeSDK
{
    ...
    public partial class DAGArrayInputAlias : OpenAPIGenBaseModel, IEquatable<DAGArrayInputAlias>, IValidatableObject
    {
        /// <summary>
        ...
        (
            ...
            Dictionary<string, string> annotations= default, string description= default, List<object> _default= default, Object spec= default, ItemType itemsType= ItemType.String // Optional parameters
        ) : base()// BaseClass
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for DAGArrayInputAlias and cannot be null");
