...
namespace QueenbeeSDK
{
    ...
    /// An integer input.
    /// </summary>
    [DataContract(Name = "StepIntegerInput")]
    public partial class StepIntegerInput : GenericInput, IEquatable<StepIntegerInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StepIntegerInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StepIntegerInput() 
        { 
        ...
        public StepIntegerInput
        (
            string name, int value, // Required parameters
        ...
        /// </summary>
        /// <returns>StepIntegerInput object</returns>
        public static StepIntegerInput FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<StepIntegerInput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>StepIntegerInput object</returns>
        public virtual StepIntegerInput DuplicateStepIntegerInput()
        {
        ...
        {
            return DuplicateStepIntegerInput();
        }
        ...
        {
            return this.Equals(input as StepIntegerInput);
        }

        /// <summary>
        /// Returns true if StepIntegerInput instances are equal
        /// </summary>
        /// <param name="input">Instance of StepIntegerInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StepIntegerInput input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^StepIntegerInput$", RegexOptions.CultureInvariant);
