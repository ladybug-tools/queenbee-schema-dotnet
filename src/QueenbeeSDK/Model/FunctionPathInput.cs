...
namespace QueenbeeSDK
{
    ...
    /// </summary>
    [DataContract(Name = "FunctionPathInput")]
    public partial class FunctionPathInput : OpenAPIGenBaseModel, IEquatable<FunctionPathInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FunctionPathInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FunctionPathInput() 
        { 
            // Set non-required readonly properties with defaultValue
            this.Type = "FunctionPathInput";
        }
        ...
        public FunctionPathInput
        (
             string name, string path, // Required parameters
            Dictionary<string, string> annotations= default, string description= default, AnyOf<HTTP,S3,ProjectFolder> _default= default, Object spec= default, List<AnyOf<DAGGenericInputAlias,DAGStringInputAlias,DAGIntegerInputAlias,DAGNumberInputAlias,DAGBooleanInputAlias,DAGFolderInputAlias,DAGFileInputAlias,DAGPathInputAlias,DAGArrayInputAlias,DAGJSONObjectInputAlias>> alias= default, List<string> extensions= default // Optional parameters
        ) : base()// BaseClass
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for FunctionPathInput and cannot be null");
            // to ensure "path" is required (not null)
            this.Path = path ?? throw new ArgumentNullException("path is a required property for FunctionPathInput and cannot be null");
        ...
        /// </summary>
        /// <returns>FunctionPathInput object</returns>
        public static FunctionPathInput FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<FunctionPathInput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>FunctionPathInput object</returns>
        public virtual FunctionPathInput DuplicateFunctionPathInput()
        {
        ...
        {
            return DuplicateFunctionPathInput();
        }
        ...
        {
            return this.Equals(input as FunctionPathInput);
        }

        /// <summary>
        /// Returns true if FunctionPathInput instances are equal
        /// </summary>
        /// <param name="input">Instance of FunctionPathInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FunctionPathInput input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^FunctionPathInput$", RegexOptions.CultureInvariant);
