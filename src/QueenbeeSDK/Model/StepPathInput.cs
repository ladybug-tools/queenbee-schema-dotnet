...
namespace QueenbeeSDK
{
    ...
    /// </summary>
    [DataContract(Name = "StepPathInput")]
    public partial class StepPathInput : GenericInput, IEquatable<StepPathInput>, IValidatableObject
    {
        /// <summary>
        ...
        ) : base(name: name, annotations: annotations, description: description)// BaseClass
        {
            ...
            this.Source = source ?? throw new ArgumentNullException("source is a required property for StepPathInput and cannot be null");
        ...
        public override string Type { get; protected internal set; }  = "StepPathInput";
        ...
        {
            var obj = JsonConvert.DeserializeObject<StepPathInput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>StepPathInput object</returns>
        public virtual StepPathInput DuplicateStepPathInput()
        {
