...
namespace QueenbeeSDK
{
    ...
    /// </summary>
    [DataContract(Name = "FunctionBooleanInput")]
    public partial class FunctionBooleanInput : GenericInput, IEquatable<FunctionBooleanInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FunctionBooleanInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FunctionBooleanInput() 
        { 
            // Set non-required readonly properties with defaultValue
            this.Type = "FunctionBooleanInput";
        }
        ...
        public FunctionBooleanInput
        (
            string name, // Required parameters
            Dictionary<string, string> annotations= default, string description= default, bool _default= default, List<AnyOf<DAGGenericInputAlias,DAGStringInputAlias,DAGIntegerInputAlias,DAGNumberInputAlias,DAGBooleanInputAlias,DAGFolderInputAlias,DAGFileInputAlias,DAGPathInputAlias,DAGArrayInputAlias,DAGJSONObjectInputAlias,DAGLinkedInputAlias>> alias= default, bool required = false, Object spec= default // Optional parameters
        ...
        public override string Type { get; protected internal set; }  = "FunctionBooleanInput";
        ...
        public override string ToString(bool detailed)
        {
            ...
            sb.Append("FunctionBooleanInput:\n");
        ...
        /// </summary>
        /// <returns>FunctionBooleanInput object</returns>
        public static FunctionBooleanInput FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<FunctionBooleanInput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>FunctionBooleanInput object</returns>
        public virtual FunctionBooleanInput DuplicateFunctionBooleanInput()
        {
        ...
        {
            return DuplicateFunctionBooleanInput();
        }
        ...
        public override bool Equals(object input)
        {
            ...
            return this.Equals(input as FunctionBooleanInput);
        }

        /// <summary>
        /// Returns true if FunctionBooleanInput instances are equal
        /// </summary>
        /// <param name="input">Instance of FunctionBooleanInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FunctionBooleanInput input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^FunctionBooleanInput$", RegexOptions.CultureInvariant);
