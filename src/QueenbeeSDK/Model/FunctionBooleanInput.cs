...
namespace QueenbeeSDK
{
    ...
    public partial class FunctionBooleanInput : OpenAPIGenBaseModel, IEquatable<FunctionBooleanInput>, IValidatableObject
    {
        /// <summary>
        ...
        (
            ...
            Dictionary<string, string> annotations= default, string description= default, bool _default= default, bool required = false, Object spec= default, List<AnyOf<DAGGenericInputAlias,DAGStringInputAlias,DAGIntegerInputAlias,DAGNumberInputAlias,DAGBooleanInputAlias,DAGFolderInputAlias,DAGFileInputAlias,DAGPathInputAlias,DAGArrayInputAlias,DAGJSONObjectInputAlias>> alias= default // Optional parameters
        ) : base()// BaseClass
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for FunctionBooleanInput and cannot be null");
