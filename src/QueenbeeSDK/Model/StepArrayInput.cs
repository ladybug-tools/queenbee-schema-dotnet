...
namespace QueenbeeSDK
{
    ...
    public partial class StepArrayInput : GenericInput, IEquatable<StepArrayInput>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StepArrayInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StepArrayInput() 
        { 
            // Set non-required readonly properties with defaultValue
            this.Type = "StepArrayInput";
        }
        ...
        public StepArrayInput
        (
            string name, List<object> value, // Required parameters
        ...
        ) : base(name: name, annotations: annotations, description: description)// BaseClass
        {
            ...
            this.Value = value ?? throw new ArgumentNullException("value is a required property for StepArrayInput and cannot be null");
        ...
        public override string Type { get; protected internal set; }  = "StepArrayInput";
        ...
        /// </summary>
        /// <returns>StepArrayInput object</returns>
        public static StepArrayInput FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<StepArrayInput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>StepArrayInput object</returns>
        public virtual StepArrayInput DuplicateStepArrayInput()
        {
        ...
        {
            return DuplicateStepArrayInput();
        }
        ...
        {
            return this.Equals(input as StepArrayInput);
        }

        /// <summary>
        /// Returns true if StepArrayInput instances are equal
        /// </summary>
        /// <param name="input">Instance of StepArrayInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StepArrayInput input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^StepArrayInput$", RegexOptions.CultureInvariant);
