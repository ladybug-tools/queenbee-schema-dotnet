...
namespace QueenbeeSDK
{
    ...
    /// </summary>
    [DataContract(Name = "InputFileReference")]
    public partial class InputFileReference : InputReferenceBase, IEquatable<InputFileReference>, IValidatableObject
    {
        ...
        public override string Type { get; protected internal set; }  = "InputFileReference";
        ...
        {
            var obj = JsonConvert.DeserializeObject<InputFileReference>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>InputFileReference object</returns>
        public virtual InputFileReference DuplicateInputFileReference()
        {
        ...
        {
            return DuplicateInputFileReference();
        }
