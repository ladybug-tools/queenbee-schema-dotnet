...
namespace QueenbeeSDK.Model
{
    ...
    public partial class DAGStringOutput : GenericOutput,  IEquatable<DAGStringOutput>, IValidatableObject
    {
        ...
        ) : base(name: name, annotations: annotations, description: description)// BaseClass
        {
            ...
            if (from == null)
            {
                throw new InvalidDataException("from is a required property for DAGStringOutput and cannot be null");
            }
            else
            {
                this.From = from;
        ...
        [JsonProperty("type")]
        public string Type { get; private set; }  = "DAGStringOutput";
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DAGStringOutput {\n");
        ...
        /// </summary>
        /// <returns>DAGStringOutput object</returns>
        public DAGStringOutput DuplicateDAGStringOutput()
        {
