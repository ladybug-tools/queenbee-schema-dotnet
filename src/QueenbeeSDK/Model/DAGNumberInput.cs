...
namespace QueenbeeSDK
{
    ...
    public partial class DAGNumberInput : OpenAPIGenBaseModel, IEquatable<DAGNumberInput>, IValidatableObject
    {
        /// <summary>
