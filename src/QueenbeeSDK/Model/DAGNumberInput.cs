...
namespace QueenbeeSDK
{
    ...
    /// </summary>
    [DataContract(Name = "DAGNumberInput")]
    public partial class DAGNumberInput : GenericInput, IEquatable<DAGNumberInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DAGNumberInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DAGNumberInput() 
        { 
            // Set non-required readonly properties with defaultValue
            this.Type = "DAGNumberInput";
        }
        ...
        public override string Type { get; protected internal set; }  = "DAGNumberInput";
        ...
        /// </summary>
        /// <returns>DAGNumberInput object</returns>
        public static DAGNumberInput FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<DAGNumberInput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>DAGNumberInput object</returns>
        public virtual DAGNumberInput DuplicateDAGNumberInput()
        {
        ...
        {
            return DuplicateDAGNumberInput();
        }
        ...
        public override bool Equals(object input)
        {
            ...
            return this.Equals(input as DAGNumberInput);
        }

        /// <summary>
        /// Returns true if DAGNumberInput instances are equal
        /// </summary>
        /// <param name="input">Instance of DAGNumberInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DAGNumberInput input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^DAGNumberInput$", RegexOptions.CultureInvariant);
