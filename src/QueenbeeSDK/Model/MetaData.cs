...
namespace QueenbeeSDK.Model
{
    ...
    public partial class MetaData :  IEquatable<MetaData>, IValidatableObject
    {
        ...
        (
           ...
           string appVersion= default, List<string> keywords= default, List<Maintainer> maintainers= default, string home= default, List<string> sources= default, string icon= default, bool deprecated= default, string description= default, License license= default// Optional parameters
        )// BaseClass
        {
