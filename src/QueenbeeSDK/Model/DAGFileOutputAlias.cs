...
namespace QueenbeeSDK
{
    ...
    public partial class DAGFileOutputAlias : GenericOutput, IEquatable<DAGFileOutputAlias>, IValidatableObject
    {
        /// <summary>
        ...
        ) : base(name: name, annotations: annotations, description: description)// BaseClass
        {
            ...
            this.Platform = platform ?? throw new ArgumentNullException("platform is a required property for DAGFileOutputAlias and cannot be null");
            // to ensure "handler" is required (not null)
            this.Handler = handler ?? throw new ArgumentNullException("handler is a required property for DAGFileOutputAlias and cannot be null");
