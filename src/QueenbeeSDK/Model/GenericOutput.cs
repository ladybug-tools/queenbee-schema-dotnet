...
namespace QueenbeeSDK
{
    ...
    public partial class GenericOutput : OpenAPIGenBaseModel, IEquatable<GenericOutput>, IValidatableObject
    {
        ...
        /// </summary>
        /// <returns>GenericOutput object</returns>
        public static GenericOutput FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<GenericOutput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>GenericOutput object</returns>
        public virtual GenericOutput DuplicateGenericOutput()
        {
