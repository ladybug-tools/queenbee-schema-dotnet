...
namespace QueenbeeSDK
{
    ...
    public partial class DAGFileInput : OpenAPIGenBaseModel, IEquatable<DAGFileInput>, IValidatableObject
    {
        ...
        /// </summary>
        /// <returns>DAGFileInput object</returns>
        public static DAGFileInput FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<DAGFileInput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>DAGFileInput object</returns>
        public virtual DAGFileInput DuplicateDAGFileInput()
        {
        ...
        {
            return this.Equals(input as DAGFileInput);
        }

        /// <summary>
        /// Returns true if DAGFileInput instances are equal
        /// </summary>
        /// <param name="input">Instance of DAGFileInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DAGFileInput input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^DAGFileInput$", RegexOptions.CultureInvariant);
