...
namespace QueenbeeSDK.Model
{
    ...
    public partial class DAGFileInput : OpenAPIGenBaseModel,  IEquatable<DAGFileInput>, IValidatableObject
    {
        ...
        ) : base()// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGFileInput and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        [JsonProperty("type")]
        public string Type { get; private set; }  = "DAGFileInput";
        ...
        /// </summary>
        /// <returns>DAGFileInput object</returns>
        public DAGFileInput DuplicateDAGFileInput()
        {
