...
namespace QueenbeeSDK.Model
{
    ...
    public partial class TaskReference : BaseReference,  IEquatable<TaskReference>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>TaskReference object</returns>
        public TaskReference DuplicateTaskReference()
        {
        ...
        protected IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> BaseValidate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^_TaskReference$", RegexOptions.CultureInvariant);
