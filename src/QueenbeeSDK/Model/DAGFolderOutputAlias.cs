...
namespace QueenbeeSDK
{
    ...
    public partial class DAGFolderOutputAlias : GenericOutput, IEquatable<DAGFolderOutputAlias>, IValidatableObject
    {
        /// <summary>
        ...
        (
            string name, AnyOf<TaskReference,FolderReference> from, List<string> platform, List<IOAliasHandler> handler, // Required parameters
        ...
        ) : base(name: name, annotations: annotations, description: description)// BaseClass
        {
            ...
            this.Platform = platform ?? throw new ArgumentNullException("platform is a required property for DAGFolderOutputAlias and cannot be null");
            // to ensure "handler" is required (not null)
            this.Handler = handler ?? throw new ArgumentNullException("handler is a required property for DAGFolderOutputAlias and cannot be null");
