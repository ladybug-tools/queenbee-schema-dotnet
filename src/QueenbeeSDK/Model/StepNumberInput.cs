...
namespace QueenbeeSDK
{
    ...
    /// A number input.
    /// </summary>
    [DataContract(Name = "StepNumberInput")]
    public partial class StepNumberInput : GenericInput, IEquatable<StepNumberInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StepNumberInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StepNumberInput() 
        { 
            // Set non-required readonly properties with defaultValue
            this.Type = "StepNumberInput";
        }
        ...
        public StepNumberInput
        (
            string name, double value, // Required parameters
            Dictionary<string, string> annotations= default, string description= default, double _default= default, List<AnyOf<DAGGenericInputAlias,DAGStringInputAlias,DAGIntegerInputAlias,DAGNumberInputAlias,DAGBooleanInputAlias,DAGFolderInputAlias,DAGFileInputAlias,DAGPathInputAlias,DAGArrayInputAlias,DAGJSONObjectInputAlias,DAGLinkedInputAlias>> alias= default, bool required = false, Object spec= default // Optional parameters
        ...
        public override string Type { get; protected internal set; }  = "StepNumberInput";
        ...
        /// </summary>
        /// <returns>StepNumberInput object</returns>
        public static StepNumberInput FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<StepNumberInput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>StepNumberInput object</returns>
        public virtual StepNumberInput DuplicateStepNumberInput()
        {
        ...
        {
            return DuplicateStepNumberInput();
        }
        ...
        {
            return this.Equals(input as StepNumberInput);
        }

        /// <summary>
        /// Returns true if StepNumberInput instances are equal
        /// </summary>
        /// <param name="input">Instance of StepNumberInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StepNumberInput input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^StepNumberInput$", RegexOptions.CultureInvariant);
