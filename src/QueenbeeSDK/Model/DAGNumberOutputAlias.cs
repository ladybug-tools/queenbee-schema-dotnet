...
namespace QueenbeeSDK
{
    ...
    /// </summary>
    [DataContract(Name = "DAGNumberOutputAlias")]
    public partial class DAGNumberOutputAlias : GenericOutput, IEquatable<DAGNumberOutputAlias>, IValidatableObject
    {
        /// <summary>
        ...
        ) : base(name: name, annotations: annotations, description: description)// BaseClass
        {
            ...
            this.From = from ?? throw new ArgumentNullException("from is a required property for DAGNumberOutputAlias and cannot be null");
            // to ensure "platform" is required (not null)
            this.Platform = platform ?? throw new ArgumentNullException("platform is a required property for DAGNumberOutputAlias and cannot be null");
            // to ensure "handler" is required (not null)
            this.Handler = handler ?? throw new ArgumentNullException("handler is a required property for DAGNumberOutputAlias and cannot be null");
        ...
        public override string ToString(bool detailed)
        {
            ...
            sb.Append("DAGNumberOutputAlias:\n");
        ...
        /// </summary>
        /// <returns>DAGNumberOutputAlias object</returns>
        public static DAGNumberOutputAlias FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<DAGNumberOutputAlias>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>DAGNumberOutputAlias object</returns>
        public virtual DAGNumberOutputAlias DuplicateDAGNumberOutputAlias()
        {
        ...
        {
            return DuplicateDAGNumberOutputAlias();
        }
