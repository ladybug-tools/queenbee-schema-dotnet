...
namespace QueenbeeSDK
{
    ...
    /// </summary>
    [DataContract(Name = "DAGObjectInputAlias")]
    [JsonConverter(typeof(JsonSubtypes), "Type")]
    public partial class DAGObjectInputAlias : OpenAPIGenBaseModel, IEquatable<DAGObjectInputAlias>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DAGObjectInputAlias" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DAGObjectInputAlias() 
        { 
            // Set non-required readonly properties with defaultValue
            this.Type = "DAGObjectInputAlias";
        }
        ...
        ) : base()// BaseClass
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for DAGObjectInputAlias and cannot be null");
            // to ensure "platform" is required (not null)
            this.Platform = platform ?? throw new ArgumentNullException("platform is a required property for DAGObjectInputAlias and cannot be null");
            // to ensure "handler" is required (not null)
            this.Handler = handler ?? throw new ArgumentNullException("handler is a required property for DAGObjectInputAlias and cannot be null");
        ...
        /// </summary>
        /// <returns>DAGObjectInputAlias object</returns>
        public static DAGObjectInputAlias FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<DAGObjectInputAlias>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>DAGObjectInputAlias object</returns>
        public virtual DAGObjectInputAlias DuplicateDAGObjectInputAlias()
        {
        ...
        {
            return DuplicateDAGObjectInputAlias();
        }
        ...
        {
            return this.Equals(input as DAGObjectInputAlias);
        }

        /// <summary>
        /// Returns true if DAGObjectInputAlias instances are equal
        /// </summary>
        /// <param name="input">Instance of DAGObjectInputAlias to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DAGObjectInputAlias input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^DAGObjectInputAlias$", RegexOptions.CultureInvariant);
