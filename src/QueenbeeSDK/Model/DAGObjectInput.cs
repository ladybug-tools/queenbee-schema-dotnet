...
namespace QueenbeeSDK.Model
{
    ...
    public partial class DAGObjectInput : OpenAPIGenBaseModel,  IEquatable<DAGObjectInput>, IValidatableObject
    {
        ...
        ) : base()// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGObjectInput and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        [JsonProperty("type")]
        public string Type { get; private set; }  = "DAGObjectInput";
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DAGObjectInput {\n");
        ...
        /// </summary>
        /// <returns>DAGObjectInput object</returns>
        public DAGObjectInput DuplicateDAGObjectInput()
        {
