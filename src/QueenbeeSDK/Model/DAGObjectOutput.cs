...
namespace QueenbeeSDK.Model
{
    ...
    public partial class DAGObjectOutput : GenericOutput,  IEquatable<DAGObjectOutput>, IValidatableObject
    {
        ...
        ) : base(name: name, annotations: annotations, description: description)// BaseClass
        {
            ...
            if (from == null)
            {
                throw new InvalidDataException("from is a required property for DAGObjectOutput and cannot be null");
            }
            else
            {
                this.From = from;
        ...
        [JsonProperty("type")]
        public string Type { get; private set; }  = "DAGObjectOutput";
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DAGObjectOutput {\n");
        ...
        /// </summary>
        /// <returns>DAGObjectOutput object</returns>
        public DAGObjectOutput DuplicateDAGObjectOutput()
        {
