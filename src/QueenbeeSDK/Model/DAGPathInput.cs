...
namespace QueenbeeSDK
{
    ...
    /// </summary>
    [DataContract(Name = "DAGPathInput")]
    public partial class DAGPathInput : OpenAPIGenBaseModel, IEquatable<DAGPathInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DAGPathInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DAGPathInput() 
        { 
            // Set non-required readonly properties with defaultValue
            this.Type = "DAGPathInput";
        }
        ...
        ) : base()// BaseClass
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for DAGPathInput and cannot be null");
        ...
        /// </summary>
        /// <returns>DAGPathInput object</returns>
        public static DAGPathInput FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<DAGPathInput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>DAGPathInput object</returns>
        public virtual DAGPathInput DuplicateDAGPathInput()
        {
        ...
        /// <summary>
        /// Returns true if DAGPathInput instances are equal
        /// </summary>
        /// <param name="input">Instance of DAGPathInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DAGPathInput input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^DAGPathInput$", RegexOptions.CultureInvariant);
