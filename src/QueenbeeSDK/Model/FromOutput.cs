...
namespace QueenbeeSDK
{
    ...
    public partial class FromOutput : GenericOutput, IEquatable<FromOutput>, IValidatableObject
    {
        ...
        /// </summary>
        /// <returns>FromOutput object</returns>
        public static FromOutput FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<FromOutput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>FromOutput object</returns>
        public virtual FromOutput DuplicateFromOutput()
        {
