...
namespace QueenbeeSDK
{
    ...
    public partial class FunctionIntegerInput : OpenAPIGenBaseModel, IEquatable<FunctionIntegerInput>, IValidatableObject
    {
        /// <summary>
        ...
        (
            ...
            Dictionary<string, string> annotations= default, string description= default, int _default= default, bool required = false, Object spec= default, List<AnyOf<DAGGenericInputAlias,DAGStringInputAlias,DAGIntegerInputAlias,DAGNumberInputAlias,DAGBooleanInputAlias,DAGFolderInputAlias,DAGFileInputAlias,DAGPathInputAlias,DAGArrayInputAlias,DAGJSONObjectInputAlias>> alias= default // Optional parameters
        ) : base()// BaseClass
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for FunctionIntegerInput and cannot be null");
