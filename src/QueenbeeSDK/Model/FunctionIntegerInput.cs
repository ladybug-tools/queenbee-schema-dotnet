...
namespace QueenbeeSDK
{
    ...
    /// </summary>
    [DataContract(Name = "FunctionIntegerInput")]
    public partial class FunctionIntegerInput : GenericInput, IEquatable<FunctionIntegerInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FunctionIntegerInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FunctionIntegerInput() 
        { 
            // Set non-required readonly properties with defaultValue
            this.Type = "FunctionIntegerInput";
        }
        ...
        public FunctionIntegerInput
        (
            string name, // Required parameters
            Dictionary<string, string> annotations= default, string description= default, int _default= default, List<AnyOf<DAGGenericInputAlias,DAGStringInputAlias,DAGIntegerInputAlias,DAGNumberInputAlias,DAGBooleanInputAlias,DAGFolderInputAlias,DAGFileInputAlias,DAGPathInputAlias,DAGArrayInputAlias,DAGJSONObjectInputAlias,DAGLinkedInputAlias>> alias= default, bool required = false, Object spec= default // Optional parameters
        ...
        public override string Type { get; protected internal set; }  = "FunctionIntegerInput";
        ...
        public override string ToString(bool detailed)
        {
            ...
            sb.Append("FunctionIntegerInput:\n");
        ...
        /// </summary>
        /// <returns>FunctionIntegerInput object</returns>
        public static FunctionIntegerInput FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<FunctionIntegerInput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>FunctionIntegerInput object</returns>
        public virtual FunctionIntegerInput DuplicateFunctionIntegerInput()
        {
        ...
        {
            return DuplicateFunctionIntegerInput();
        }
        ...
        public override bool Equals(object input)
        {
            ...
            return this.Equals(input as FunctionIntegerInput);
        }

        /// <summary>
        /// Returns true if FunctionIntegerInput instances are equal
        /// </summary>
        /// <param name="input">Instance of FunctionIntegerInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FunctionIntegerInput input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^FunctionIntegerInput$", RegexOptions.CultureInvariant);
