...
namespace QueenbeeSDK
{
    ...
    public partial class FunctionArrayInput : GenericInput, IEquatable<FunctionArrayInput>, IValidatableObject
    {
        ...
        public override string Type { get; protected internal set; }  = "FunctionArrayInput";
        ...
        {
            var obj = JsonConvert.DeserializeObject<FunctionArrayInput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>FunctionArrayInput object</returns>
        public virtual FunctionArrayInput DuplicateFunctionArrayInput()
        {
