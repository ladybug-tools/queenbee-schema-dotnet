...
namespace QueenbeeSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaskParameterReference :  IEquatable<TaskParameterReference>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        protected TaskParameterReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskParameterReference" /> class.
        /// </summary>
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for TaskParameterReference and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (variable == null)
            {
                throw new InvalidDataException("variable is a required property for TaskParameterReference and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskParameterReference {\n");
        ...
        /// </summary>
        /// <returns>TaskParameterReference object</returns>
        public static TaskParameterReference FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<TaskParameterReference>(json, JsonSetting.AnyOfConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>TaskParameterReference object</returns>
        public TaskParameterReference DuplicateTaskParameterReference()
        {
        ...
        {
            return this.Equals(input as TaskParameterReference);
        }

        /// <summary>
        /// Returns true if TaskParameterReference instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskParameterReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskParameterReference input)
        {
            if (input == null)
                return false;
