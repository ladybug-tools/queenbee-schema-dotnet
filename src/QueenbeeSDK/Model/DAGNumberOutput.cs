...
namespace QueenbeeSDK.Model
{
    ...
    public partial class DAGNumberOutput : GenericOutput,  IEquatable<DAGNumberOutput>, IValidatableObject
    {
        ...
        ) : base(name: name, annotations: annotations, description: description)// BaseClass
        {
            ...
            if (from == null)
            {
                throw new InvalidDataException("from is a required property for DAGNumberOutput and cannot be null");
            }
            else
            {
                this.From = from;
        ...
        [JsonProperty("type")]
        public string Type { get; private set; }  = "DAGNumberOutput";
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DAGNumberOutput {\n");
        ...
        /// </summary>
        /// <returns>DAGNumberOutput object</returns>
        public DAGNumberOutput DuplicateDAGNumberOutput()
        {
