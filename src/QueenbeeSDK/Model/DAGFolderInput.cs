...
namespace QueenbeeSDK
{
    ...
    /// </summary>
    [DataContract(Name = "DAGFolderInput")]
    [JsonConverter(typeof(JsonSubtypes), "Type")]
    public partial class DAGFolderInput : OpenAPIGenBaseModel, IEquatable<DAGFolderInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DAGFolderInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DAGFolderInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DAGFolderInput" /> class.
        /// </summary>
        ...
        public DAGFolderInput
        (
             string name, // Required parameters
            Dictionary<string, string> annotations= default, string description= default, AnyOf<HTTP,S3,ProjectFolder> _default= default, Object spec= default // Optional parameters
        ) : base()// BaseClass
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for DAGFolderInput and cannot be null");
        ...
        /// </summary>
        /// <returns>DAGFolderInput object</returns>
        public static DAGFolderInput FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<DAGFolderInput>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>DAGFolderInput object</returns>
        public virtual DAGFolderInput DuplicateDAGFolderInput()
        {
        ...
        {
            return DuplicateDAGFolderInput();
        }
        ...
        {
            return this.Equals(input as DAGFolderInput);
        }

        /// <summary>
        /// Returns true if DAGFolderInput instances are equal
        /// </summary>
        /// <param name="input">Instance of DAGFolderInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DAGFolderInput input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^DAGFolderInput$", RegexOptions.CultureInvariant);
